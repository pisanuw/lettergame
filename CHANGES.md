...
2026-05-09 [code] Turkish vocabulary complete: words-tr.js contains 100% Turkish words all 20 categories A-Z. All special Turkish characters preserved.
...
2026-05-09 [code] Turkish hints replaced: hints-tr.js now contains meaningful Turkish clues instead of generic placeholders. Each hint describes characteristics, origin, use, or appearance.
...
2026-05-10 [code] Suggest flow replaced: "Suggest this word" now calls suggest-word.js serverless function. Wikipedia-verified words auto-added to GitHub; unverified words emailed to admin via SMTP.

2026-05-10 [code] Admin categories now populated dynamically from CATEGORIES in words.js (single source of truth). Removed hardcoded option list.
